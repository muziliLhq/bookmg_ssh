...
<body>
<!-- 请求方式: get/post，默认get -->
<form id="userForm" action=" ${basePath}user/update" method="post"
    ...
    <div class="form-control">
        <input id="name" name="name" value="${userModel.name }"/>*可修改
    </div>
    <div class="form-control">
        <input id="idCard" name="idCard" value="${userModel.idCard }" readonly/>
    </div>
    <div class="form-control">
        <input id="password" name="password" value="${userModel.password }"/>*可修改
    </div>
    <div class="form-control">
